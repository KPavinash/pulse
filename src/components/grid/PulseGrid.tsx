                            ...
                            >
                                ...
                                {isLocked && (
                                    <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
                                        <div className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center mb-2 shadow-[0_0_20px_rgba(255,255,255,0.1)]">
                                            <div className="w-8 h-8 text-white"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg></div>
                                        </div>
                                        <span className="text-xs font-bold text-white tracking-widest uppercase mb-1">Premium</span>
                                        <span className="text-[10px] text-white/60">Tap to unlock</span>
                                    </div>
                                )}
